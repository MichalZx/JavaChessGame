...
public class Krol extends Figura {
    ...
    public int[][] czySzach(int[] pozycjaKrola, Color kolorSprawdzany){ //sprawdza dla każdej przeciwnej figury czy szachuje króla
        ...
        //goniec hetman
        for(int i = pozycjaKrola[0] + 1, j = pozycjaKrola[1] + 1; i <= 7 && j <= 7; i++, j++){ //prawy dolny
            ...
            else if(Szachownica.plansza[i][j] != null)
                break;
        }
        for(int i = pozycjaKrola[0] - 1, j = pozycjaKrola[1] + 1; i >= 0 && j <= 7; i--, j++){ //prawy górny
            int [] dozwolonyRuch = new int[2];
            if(Szachownica.plansza[i][j] != null && Szachownica.plansza[i][j].getKolor() != kolorSprawdzany && ( Szachownica.plansza[i][j] instanceof Goniec || Szachownica.plansza[i][j] instanceof Hetman )){
                dozwolonyRuch[0] = i;
                dozwolonyRuch[1] = j;
        ...
        for(int i = pozycjaKrola[0] - 1, j = pozycjaKrola[1] - 1; i >= 0 && j >= 0; i--, j--){ //lewy górny
            int [] dozwolonyRuch = new int[2];
            if(Szachownica.plansza[i][j] != null && Szachownica.plansza[i][j].getKolor() != kolorSprawdzany && ( Szachownica.plansza[i][j] instanceof Goniec || Szachownica.plansza[i][j] instanceof Hetman )){
                dozwolonyRuch[0] = i;
                dozwolonyRuch[1] = j;
        ...
        for(int i = pozycjaKrola[0] + 1, j = pozycjaKrola[1] - 1; i <= 7 && j >= 0; i++, j--){ //lewy dolny
            int [] dozwolonyRuch = new int[2];
            if(Szachownica.plansza[i][j] != null && Szachownica.plansza[i][j].getKolor() != kolorSprawdzany && ( Szachownica.plansza[i][j] instanceof Goniec || Szachownica.plansza[i][j] instanceof Hetman )){
                dozwolonyRuch[0] = i;
                dozwolonyRuch[1] = j;
        ...
        //wieza hetman
        for(int i = pozycjaKrola[0] - 1; i >= 0; i--){ //góra
            int [] dozwolonyRuch = new int[2];
            ...
            else if(Szachownica.plansza[i][pozycjaKrola[1]] != null)
                break;
        }
        for(int i = pozycjaKrola[0] + 1; i < 8; i++){ //dół
            int [] dozwolonyRuch = new int[2];
            if(Szachownica.plansza[i][pozycjaKrola[1]] != null && Szachownica.plansza[i][pozycjaKrola[1]].getKolor() != kolorSprawdzany && ( Szachownica.plansza[i][pozycjaKrola[1]] instanceof Wieza || Szachownica.plansza[i][pozycjaKrola[1]] instanceof Hetman )){
                dozwolonyRuch[0] = i;
                dozwolonyRuch[1] = pozycjaKrola[1];
        ...
        for(int i = pozycjaKrola[1] - 1; i >= 0; i--){ //lewo
            int[] dozwolonyRuch = new int[2];
            ...
            else if(Szachownica.plansza[pozycjaKrola[0]][i] != null)
                break;
        }
        for(int i = pozycjaKrola[1] + 1; i < 8; i++){ //prawo
            int[] dozwolonyRuch = new int[2];
            if(Szachownica.plansza[pozycjaKrola[0]][i] != null && Szachownica.plansza[pozycjaKrola[0]][i].getKolor() != kolorSprawdzany && ( Szachownica.plansza[i][pozycjaKrola[1]] instanceof Wieza || Szachownica.plansza[i][pozycjaKrola[1]] instanceof Hetman )){
                dozwolonyRuch[0] = pozycjaKrola[0];
                dozwolonyRuch[1] = i;
        ...
        if ( pozycjaKrola[0] + 2 <= 7 ){
            if ( pozycjaKrola[1] + 1 <= 7 ){
                int[] dozwolonyRuch = new int[2];
                if(Szachownica.plansza[pozycjaKrola[0] + 2][pozycjaKrola[1] + 1] != null && Szachownica.plansza[pozycjaKrola[0] + 2][pozycjaKrola[1] + 1].getKolor() != kolorSprawdzany && Szachownica.plansza[pozycjaKrola[0] + 2][pozycjaKrola[1] + 1] instanceof Skoczek){
        ...
        //pion
         if(kolorSprawdzany == Color.YELLOW_BOLD){
             if(pozycjaKrola[1] != 0 && pozycjaKrola[0] != 7 && Szachownica.plansza[pozycjaKrola[0] + 1][pozycjaKrola[1] - 1] != null && Szachownica.plansza[pozycjaKrola[0] + 1][pozycjaKrola[1] - 1].getKolor() != kolorSprawdzany && Szachownica.plansza[pozycjaKrola[0] + 1][pozycjaKrola[1] - 1] instanceof Pion){
                 int[] dozwolonyRuch = new int[2];
                 dozwolonyRuch[0] = pozycjaKrola[0] + 1;
                 dozwolonyRuch[1] = pozycjaKrola[1] - 1;
                 listaDozwolonyuchRuchow.add(dozwolonyRuch);
             }
             else if(pozycjaKrola[1] != 7 && pozycjaKrola[0] != 7 && Szachownica.plansza[pozycjaKrola[0] + 1][pozycjaKrola[1] + 1] != null && Szachownica.plansza[pozycjaKrola[0] + 1][pozycjaKrola[1] + 1].getKolor() != kolorSprawdzany && Szachownica.plansza[pozycjaKrola[0] + 1][pozycjaKrola[1] + 1] instanceof Pion) {
                 int[] dozwolonyRuch = new int[2];
                 dozwolonyRuch[0] = pozycjaKrola[0] + 1;
                 dozwolonyRuch[1] = pozycjaKrola[1] + 1;
                 listaDozwolonyuchRuchow.add(dozwolonyRuch);
             ...
             if(pozycjaKrola[1] != 0 && pozycjaKrola[0] != 0 && Szachownica.plansza[pozycjaKrola[0] - 1][pozycjaKrola[1] - 1] != null && Szachownica.plansza[pozycjaKrola[0] - 1][pozycjaKrola[1] - 1].getKolor() != kolorSprawdzany && Szachownica.plansza[pozycjaKrola[0] - 1][pozycjaKrola[1] - 1] instanceof Pion){
                 int[] dozwolonyRuch = new int[2];
                 dozwolonyRuch[0] = pozycjaKrola[0] - 1;
                 dozwolonyRuch[1] = pozycjaKrola[1] - 1;
                 listaDozwolonyuchRuchow.add(dozwolonyRuch);
             }
             else if(pozycjaKrola[1] != 7 && pozycjaKrola[0] != 0  && Szachownica.plansza[pozycjaKrola[0] - 1][pozycjaKrola[1] + 1] != null && Szachownica.plansza[pozycjaKrola[0] - 1][pozycjaKrola[1] + 1].getKolor() != kolorSprawdzany && Szachownica.plansza[pozycjaKrola[0] - 1][pozycjaKrola[1] + 1] instanceof Pion) {
                 int[] dozwolonyRuch = new int[2];
                 dozwolonyRuch[0] = pozycjaKrola[0] - 1;
                 dozwolonyRuch[1] = pozycjaKrola[1] + 1;
                 listaDozwolonyuchRuchow.add(dozwolonyRuch);
